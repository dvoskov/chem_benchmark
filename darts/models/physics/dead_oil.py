...
class DeadOil (PhysicsBase):
    ...
    """
    def __init__(self, timer, physics_filename, n_points, min_p, max_p, min_z, discr_type = 'tpfa', with_gpu = False, static_itor=False,
                 negative_zc_strategy=0, platform='cpu', itor_type='multilinear', itor_mode='adaptive', itor_precision='d'):
        """"
